...
sorting_TDC = ss.run_sorter(
    sorter_name="tridesclous", recording=recording_preprocessed, detect_threshold=4
)
print(sorting_TDC)
...
sorting_KS2 = ss.run_sorter(
    sorter_name="kilosort2", recording=recording_preprocessed, docker_image=True, verbose=True
)
print(sorting_KS2)
...
# +
we_TDC = si.extract_waveforms(
    recording_preprocessed, sorting_TDC, "waveforms_folder", overwrite=True
)
print(we_TDC)
