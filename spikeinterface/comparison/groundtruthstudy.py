...
from spikeinterface.sorters import run_sorters, sorter_dict
...
class GroundTruthStudy:
    ...
    def run_sorters(
        self, sorter_list, mode_if_folder_exists="keep", remove_sorter_folders=False, **kwargs
    ):
    ...
    def compute_waveforms(
        ...
        we.set_params(
            ms_before=ms_before, ms_after=ms_after, max_spikes_per_unit=max_spikes_per_unit
        )
