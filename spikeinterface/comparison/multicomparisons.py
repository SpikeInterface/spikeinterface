...
from spikeinterface.core import BaseSorting, BaseSortingSegment, load_extractor
from spikeinterface.core.core_tools import define_function_from_class

from .basecomparison import (
    BaseMultiComparison,
    MixinSpikeTrainComparison,
    MixinTemplateComparison,
)
...
class MultiSortingComparison(BaseMultiComparison, MixinSpikeTrainComparison):
    ...
    def load_from_folder(folder_path):
        ...
        mcmp = MultiSortingComparison(
            sorting_list=sorting_list, name_list=list(name_list), do_matching=False, **kwargs
        )
