...
from .basecomparison import BaseSpikeTrainComparison
...
class MultiSortingComparison(BaseMultiComparison, BaseSpikeTrainComparison):
    """
    ...
    def __init__(self, sorting_list, name_list=None, delta_time=0.4,  # sampling_frequency=None,
                 ...
                 do_matching=True):
        BaseMultiComparison.__init__(self, sorting_list, name_list=name_list)
        BaseSpikeTrainComparison.__init__(self, sorting_list, name_list=name_list,
