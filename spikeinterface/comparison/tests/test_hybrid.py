...
from spikeinterface.core import extract_waveforms, load_extractor, set_global_tmp_folder
...
def test_hybrid_units_recording():
	...
	saved_1job = hybrid_units_recording.save(folder=cache_folder / "1job")
	saved_2job = hybrid_units_recording.save(folder=cache_folder / "2job", n_jobs=2, chunk_duration='1s')
