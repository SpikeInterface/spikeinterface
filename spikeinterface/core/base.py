...
class BaseExtractor:
    ...
    def dump_to_json(self, file_path=None, relative_to=None, folder_metadata=None):
        ...
        file_path.write_text(json.dumps(check_json(dump_dict), indent=4), encoding="utf8")

    def dump_to_pickle(
        self, file_path=None, include_properties=True, relative_to=None, folder_metadata=None
    ):
        """
    ...
    def save_to_folder(self, name=None, folder=None, verbose=True, **save_kwargs):
        ...
        if self.check_if_dumpable():
            ...
            provenance_file.write_text(
                json.dumps({"warning": "the provenace is not dumpable!!!"}), encoding="utf8"
            )
    ...
    def save_to_zarr(
        ...
        **save_kwargs,
        ...
        if zarr_path is not None:
            warnings.warn(
                "The 'zarr_path' argument is deprecated. " "Use 'folder' instead",
                DeprecationWarning,
                stacklevel=2,
            )
            folder = zarr_path
