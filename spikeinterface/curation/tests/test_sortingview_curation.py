...
def test_sortingview_curation():
    ...
    sorting_curated_jot_accepted = apply_sortingview_curation(
        sorting, uri_or_json=jot_uri, include_labels=["accept"]
    )
    sorting_curated_jot_rejected = apply_sortingview_curation(
        sorting, uri_or_json=jot_uri, exclude_labels=["reject"]
    )
    sorting_curated_jot_rejected1 = apply_sortingview_curation(
        sorting, uri_or_json=jot_uri, exclude_labels=["noise", "reject"]
    )
    ...
    sorting_curated_sha_accepted = apply_sortingview_curation(
        sorting, uri_or_json=sha_uri, include_labels=["accept"]
    )
    sorting_curated_sha_mua = apply_sortingview_curation(
        sorting, uri_or_json=sha_uri, exclude_labels=["mua"]
    )
    sorting_curated_sha_mua1 = apply_sortingview_curation(
        sorting, uri_or_json=sha_uri, exclude_labels=["artifact", "mua"]
    )
