...
read_mda_recording = define_reader_function(source_class=MdaRecordingExtractor, name="read_mda_recording")
read_mda_sorting = define_reader_function(source_class=MdaSortingExtractor, name="read_mda_sorting")
