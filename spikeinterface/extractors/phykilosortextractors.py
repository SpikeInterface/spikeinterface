...
read_phy = define_reader_function(source_class=PhySortingExtractor, name="read_phy")
read_kilosort = define_reader_function(source_class=KiloSortSortingExtractor, name="read_kilosort")
