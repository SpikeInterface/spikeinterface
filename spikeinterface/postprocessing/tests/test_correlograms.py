...
from spikeinterface import NumpySorting, download_dataset, extract_waveforms
from spikeinterface.core import generate_sorting
from spikeinterface.postprocessing import CorrelogramsCalculator, compute_correlograms
...
def test_detect_injected_correlation():
    ...
    for method in methods:
        ...
        half_bin_ms = np.mean(np.diff(bins)) / 2.0
