...
class UnitLocationsExtensionTest(WaveformExtensionCommonTestSuite, unittest.TestCase):
    ...
    extension_function_kwargs_list = [
        dict(method='center_of_mass', local_radius_um=100),
        dict(method='center_of_mass', local_radius_um=100, outputs='by_unit'),
        dict(method='grid_convolution', local_radius_um=50, outputs='by_unit'),
        dict(method='monopolar_triangulation', local_radius_um=150),
        dict(method='monopolar_triangulation', local_radius_um=150, outputs='by_unit'),
        dict(method='monopolar_triangulation', local_radius_um=150, outputs='by_unit',
