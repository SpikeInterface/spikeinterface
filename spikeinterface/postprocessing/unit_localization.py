...
def compute_monopolar_triangulation(waveform_extractor, optimizer='minimize_with_log_penality',
                                    radius_um=50, max_distance_um=1000, return_alpha=False, compute_from='ptp'):
    '''
...
def compute_center_of_mass(waveform_extractor, peak_sign='neg', num_channels=10, compute_from='ptp'):
    '''
