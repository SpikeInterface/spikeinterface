    ...
    def __init__(
        ...
        for parent_segment in recording._recording_segments:
            self.add_recording_segment(
                FilterRecordingSegment(parent_segment, filter_coeff, filter_mode, margin, dtype)
            )
...
class BandpassFilterRecording(FilterRecording):
    ...
    def __init__(
        self, recording, freq_min=300.0, freq_max=6000.0, margin_ms=5.0, dtype=None, **filter_kwargs
    ):
...
class HighpassFilterRecording(FilterRecording):
    ...
    def __init__(self, recording, freq_min=300.0, margin_ms=5.0, dtype=None, **filter_kwargs):
        ...
        dtype = fix_dtype(recording, dtype)
        self._kwargs = dict(
            recording=recording.to_dict(), freq_min=freq_min, margin_ms=margin_ms, dtype=dtype.str
        )
        self._kwargs.update(filter_kwargs)
...
class NotchFilterRecording(BasePreprocessor):
    ...
    def __init__(self, recording, freq=3000, q=30, margin_ms=5.0, dtype=None):
        ...
        self._kwargs = dict(
            recording=recording.to_dict(), freq=freq, q=q, margin_ms=margin_ms, dtype=dtype.str
        )
