...
from ..core import BaseRecordingSegment, get_chunk_with_margin
...
class ResampleRecording(BasePreprocessor):
    ...
    def __init__(self, recording, resample_rate, margin_ms=100.0, dtype=None, skip_checks=False):
...
class ResampleRecordingSegment(BaseRecordingSegment):
    ...
    def get_num_samples(self):
        return int(
            self._parent_segment.get_num_samples() / self._parent_rate * self.sampling_frequency
        )
