...
from spikeinterface.core import BaseRecordingSnippets, load_extractor
from spikeinterface.core.core_tools import check_json
from spikeinterface.core.job_tools import fix_job_kwargs, split_job_kwargs

from .utils import ShellScript, SpikeSortingError
...
class BaseSorter:
    ...
    def __init__(
        ...
        self.sorter_folder = (
            self.output_folder / "sorter_output" if self.output_folder is not None else None
        )
