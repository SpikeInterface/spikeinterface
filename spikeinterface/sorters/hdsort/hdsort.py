...
class HDSortSorter(BaseSorter):
    ...
    def _generate_configs_file(sorter_output_folder, params, file_name, file_format):
        ...
        P["spikeAlignment"] = {
            "initAlignment": "-",
            "maxSpikes": 50000.0,
        }  # so many spikes will be clustered
        ...
        P["spikeCutting"] = {
            "maxSpikes": 200000000000.0,
            "blockwise": False,
        }  # Set this to basically inf
        ...
        if write_file:
            ...
            with h5py.File(save_path, "w") as f:
                ...
                ephys.create_dataset(
                    "frame_numbers", data=np.arange(recording.get_num_frames(segment_index=0))
                )
                # save mapping
