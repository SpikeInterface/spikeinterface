...
from .utils import ShellScript, get_bash_path, get_matlab_shell_name
...
class KilosortBase:
    ...
    def _run_from_folder(cls, sorter_output_folder, params, verbose):
        ...
        if cls.check_compiled():
            ...
            shutil.copy(
                str(source_dir / cls.sorter_name / f"{cls.sorter_name}_master.m"),
                str(sorter_output_folder),
            )
            shutil.copy(str(source_dir / "utils" / "writeNPY.m"), str(sorter_output_folder))
            shutil.copy(
                str(source_dir / "utils" / "constructNPYheader.m"), str(sorter_output_folder)
            )
