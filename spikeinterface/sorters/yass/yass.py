...
from spikeinterface.core import load_extractor, write_binary_recording
...
class YassSorter(BaseSorter):
    ...
    def _setup_recording(cls, recording, sorter_output_folder, params, verbose):
        ...
        write_binary_recording(
            recording, file_paths=[input_file_path], dtype=dtype, **get_job_kwargs(params, verbose)
        )
        ...
        if retrain:
            ...
            if verbose:
                print(
                    "USING PREVIOUSLY TRAINED NNs FROM THIS LOCATION: ", params["neural_nets_path"]
                )
