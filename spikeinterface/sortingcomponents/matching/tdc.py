...
class TridesclousPeeler(BaseTemplateMatchingEngine):
    ...
    def initialize_and_check_kwargs(cls, recording, kwargs):
        ...
        template_sparsity_inds = get_template_channel_sparsity(
            we,
            method="threshold",
...
if HAVE_NUMBA:
    ...
    @jit(nopython=True)
    def numba_best_shift(
        traces, template, sample_ind, nbefore, possible_shifts, distances_shift, chan_sparsity
    ):
        """
