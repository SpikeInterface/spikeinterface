...
def select_peaks(peaks, method='uniform', seed=None, **method_kwargs):
    ...
    method: 'uniform', 'smart_sampling_amplitudes', 'smart_sampling_locations'
        Method to use. Options:
            ...
            * 'uniform_locations': a random subset is selected from all the peaks, on a per channel basis by default
    ...
    if method == 'uniform':
        ...
        params.update(method_kwargs)
        assert 'noise_levels' in params, "Noise levels should be provided"
