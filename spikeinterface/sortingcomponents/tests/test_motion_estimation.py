...
def test_estimate_motion():
    ...
    all_cases = {
        ...
        "rigid / decentralized / torch": dict(
            rigid=True, method="decentralized", conv_engine="torch"
        ),
    ...
    motion0, motion1 = (
        motions["rigid / decentralized / torch"],
        motions["rigid / decentralized / numpy"],
    )
    assert (motion0 == motion1).all()

    motion0, motion1 = (
        motions["non-rigid / decentralized / torch"],
        motions["non-rigid / decentralized / numpy"],
    )
    assert (motion0 == motion1).all()
