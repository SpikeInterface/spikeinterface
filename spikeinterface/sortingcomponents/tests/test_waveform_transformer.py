...
from spikeinterface.sortingcomponents.waveformtransform.denoiser import SingleChannelToyDenoiser
...
def test_single_channel_toy_denoiser_in_peak_pipeline():
    ...
    waveform_extracting_step = WaveformStep(recording, ms_before=ms_before, ms_after=ms_after,  peak_sign='neg', all_channels=True)
    # Add the waveform normalization to the step:
    toy_denoiser = SingleChannelToyDenoiser(ms_before=ms_before, ms_after=ms_after, 
                                            sampling_frequency=sampling_frequency)
    
    waveform_extracting_step.waveform_transformer_pipe = [toy_denoiser] 
