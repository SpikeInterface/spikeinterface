...
from spikeinterface import download_dataset, extract_waveforms, load_waveforms
...
class TestWidgets(unittest.TestCase):
    ...
    def test_plot_drift_over_time(self):
        ...
        sw.plot_drift_over_time(
            self._rec, peaks=peaks, bin_duration_s=1.0, weight_with_amplitudes=True, mode="heatmap"
        )
        sw.plot_drift_over_time(
