...
class PlotUpdater:
    ...
    def __call__(self, change):
        ...
        data_plot['units_in_legend'] = unit_ids
        data_plot['unit_colors'] = self.data_plot['unit_colors'].copy()
        
        for u in self.data_plot['unit_colors']:
            if u not in unit_ids:
                data_plot['unit_colors'][u] = 'gray'
