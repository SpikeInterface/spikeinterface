...
class ISIDistributionWidget(BaseMultiWidget):
    ...
    W: ISIDistributionWidget
        The output widget
    """
    def __init__(self, sorting, unit_ids=None, bins=10, window=1., figure=None, ax=None,
                 axes=None):
    ...
    def _do_plot(self):
        ...
        for i, unit_id in enumerate(unit_ids):
            for segment_index in range(num_seg):
                ...
                times = self._sorting.get_unit_spike_train(unit_id=unit_id, segment_index=segment_index) \
