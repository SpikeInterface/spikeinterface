...
def make_sorting(times1, labels1, times2, labels2, times3, labels3):
    ...
    sorting1 = NumpySorting.from_samples_labels([times1], [labels1], sampling_frequency)
    sorting2 = NumpySorting.from_samples_labels([times2], [labels2], sampling_frequency)
    sorting3 = NumpySorting.from_samples_labels([times3], [labels3], sampling_frequency)
