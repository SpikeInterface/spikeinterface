...
def get_traces_with_margin(
    ...
    """
    Helper to get traces (thus with the appropriate scaling) with margin
    ...
    if not (add_zeros or add_reflect_padding):
        ...
        traces_chunk = recording.get_traces(segment_index, start_frame2, end_frame2, channel_inds)
