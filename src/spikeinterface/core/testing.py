...
def check_recordings_equal(RX1: BaseRecording, RX2: BaseRecording, return_scaled=True, force_dtype=None, check_properties: bool = False) -> None:
...
def check_sortings_equal(SX1: BaseSorting, SX2: BaseSorting, check_properties: bool = False) -> None:
