...
def test_transformedsorting():
    sorting_1 = generate_sorting(seed=0)
    sorting_2 = generate_sorting(seed=1)

    transformed_1 = TransformedSorting(sorting_1, sorting_2.to_spike_vector())
    ...
    transformed_2 = TransformedSorting(sorting_1, sorting_2.to_spike_vector(), refractory_period_ms=20)
    n_spikes_added_2 = len(transformed_2.to_spike_vector())
    assert n_spikes_added_2 < n_spikes_added_1

    transformed_3 = TransformedSorting(sorting_1, sorting_1.to_spike_vector(), refractory_period_ms=0.1)
