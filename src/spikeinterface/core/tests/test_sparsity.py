...
def test_compute_sparsity():
    ...
    sparsity = compute_sparsity(templates, method="best_channels", num_channels=2)
    sparsity = compute_sparsity(templates, method="radius", radius_um=50.0)
    sparsity = compute_sparsity(templates, method="snr", noise_levels=noise_levels, threshold=5)
    sparsity = compute_sparsity(templates, method="amplitude", threshold=5)
