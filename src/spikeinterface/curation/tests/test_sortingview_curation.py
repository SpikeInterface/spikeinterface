...
def test_gh_curation():
    ...
    sorting_curated_gh = apply_sortingview_curation(sorting, uri_or_json=gh_uri)
...
def test_sha1_curation():
    ...
    sorting_curated_sha1 = apply_sortingview_curation(sorting, uri_or_json=sha1_uri)
...
def test_false_positive_curation():
    ...
    sorting = se.NumpySorting.from_samples_labels(times, labels, sampling_frequency)
