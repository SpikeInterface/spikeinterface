...
def test_calculate_drift_metrics(simulated_data):
    drift_ptps_gt = {
        0: 0.46840681501541326,
        1: 0.6777238017179599,
        2: 0.8942870016859388,
    }
    drift_stds_gt = {
        0: 0.1524300978308216,
        1: 0.2000278046705443,
        2: 0.2515466033662633,
    }
    drift_mads_gt = {
        0: 0.09958965007876515,
        1: 0.15344260957426314,
        2: 0.15754859427461837,
    }
