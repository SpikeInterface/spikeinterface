...
class IronClustSorter(BaseSorter):
    ...
    def set_ironclust_path(ironclust_path: PathType):
        ...
        try:
            print(
                "Setting IRONCLUST_PATH environment variable for subprocess calls to:",
                ironclust_path,
            )
    ...
    def _setup_recording(cls, recording, sorter_output_folder, params, verbose):
        ...
        if verbose:
            print(
                f"channels = {num_channels}, timepoints = {num_timepoints}, duration = {duration_minutes} minutes"
            )
