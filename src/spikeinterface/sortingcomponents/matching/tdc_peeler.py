...
class TridesclousPeeler(BaseTemplateMatching):
    ...
    def __init__(
        ...
        self.detector_margin0 = self.fast_spike_detector.get_data_margin()
        self.detector_margin1 = self.fine_spike_detector.get_data_margin() if use_fine_detector else 0
    ...
    def _find_spikes_one_level(self, traces, spikes_prev_loop, use_fine_detector, level, channel_motions):
        ...
        detector_margin = peak_detector.get_data_margin()
