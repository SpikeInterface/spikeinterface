...
def peaks(recording, job_kwargs):
    ...
    return detect_peaks(recording, method='locally_exclusive',
...
def peak_locations(recording, peaks, job_kwargs):
    return localize_peaks(recording, peaks, method='center_of_mass',
                          **job_kwargs)
...
def test_find_cluster_from_peaks(clustering_method, recording, peaks, peak_locations):
    ...
    labels, peak_labels = find_cluster_from_peaks(recording, peaks, method=clustering_method, method_kwargs=method_kwargs)
