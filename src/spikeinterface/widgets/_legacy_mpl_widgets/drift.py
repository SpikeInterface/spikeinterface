...
class DriftOverTimeWidget(BaseWidget):
    ...
    def _do_plot(self):
        ...
        if self.mode == "heatmap":
            ...
            self.ax.imshow(
                peak_density, interpolation="nearest", origin="lower", aspect="auto", extent=extent, **kwargs
            )
...
class PairwiseDisplacementWidget(BaseWidget):
    ...
    def __init__(self, motion, temporal_bins, spatial_bins, extra_check, figure=None, ax=None, ncols=5):
        import matplotlib.pylab as plt
        import scipy.sparse
...
class DisplacementWidget(BaseWidget):
    ...
    def __init__(self, motion, temporal_bins, spatial_bins, extra_check, with_histogram=True, figure=None, ax=None):
        BaseWidget.__init__(self, figure, ax)
