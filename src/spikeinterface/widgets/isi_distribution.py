...
class ISIDistributionWidget(BaseWidget):
    ...
    def __init__(
        self, sorting, unit_ids=None, window_ms=100.0, bin_ms=1.0, backend=None, **backend_kwargs
    ):
    ...
    def plot_matplotlib(self, data_plot, **backend_kwargs):
        ...
        for i, unit_id in enumerate(dp.unit_ids):
            ...
            for segment_index in range(num_segments):
                times_ms =  sorting.get_unit_spike_train(unit_id=unit_id, segment_index=segment_index) / fs * 1000.
