...
class KilosortDriftMapWidget(BaseWidget):
    ...
    def _load_ks_dir(self, sorter_output: Path, exclude_noise: bool = True, load_pcs: bool = False) -> dict:
        """
        ...
        if exclude_noise and (
            ...
            cluster_ids, cluster_groups = self._load_cluster_groups(cluster_path)
    ...
    def _load_cluster_groups(self, cluster_path: Path) -> tuple[np.ndarray, ...]:
        """
